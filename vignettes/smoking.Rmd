...
```{r echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, paged.print=FALSE}
ind <- which.min(SummarizedExperiment::rowData(de.sns_eset)$ADJ.PVAL)
otuname <- rownames(de.sns_eset)[ind]
smoker.exprs <- SummarizedExperiment::assay(de.sns_eset)[ind,de.sns_eset$GROUP==0]
nsmoker.exprs <- SummarizedExperiment::assay(de.sns_eset)[ind,de.sns_eset$GROUP==1]
