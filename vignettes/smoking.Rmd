...
NYC_HANES <- loadQiimeData(metadata = sas7bdat::read.sas7bdat('../inst/extdata/public_v2_010518.sas7bdat')) %>% annotateFactors(.)
...
```{r genus_plot, echo=FALSE, message=FALSE, warning=FALSE, fig.width=6}
...
```{r Alpha diversity boxplots, echo=FALSE, fig.height=6, fig.width=8}
...
```{r pcoa_smokers_neversmoker, echo=FALSE, message=FALSE, warning=FALSE, fig.width=6}
...
```{r pcoa_threecat, echo=FALSE, message=FALSE, warning=FALSE, fig.width=6}
...
```{r pcoa_fourcat, echo=FALSE, message=FALSE, warning=FALSE, fig.width=6}
...
```{r pcoa_all, echo=FALSE, message=FALSE, warning=FALSE,  fig.width=6}
...
```{r pcoa_cotinine, echo=FALSE, message=FALSE, warning=FALSE, fig.width=6}
plot(ggplot() +
  xlab("Axis.1")+
  ylab("Axis.2")+
  theme_bw() +
...
```{r deseq2_univariate, echo=FALSE, message=FALSE, warning=FALSE,  fig.width=6}
...
```{r deseq2_multivariate, echo=FALSE,message=FALSE, warning=FALSE,  fig.width=6}
...
```{r deseq2_univ_vs_multiv, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE,  fig.width=6}
ggplot(compardat) +
...
```{r deseq2_cotinine_univ, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE,  fig.width=6}
...
```{r edgeR_univ, echo=FALSE, fig.height=6, fig.width=8}
...
```{r edgeR_multiv, echo=FALSE, fig.height=6, fig.width=7}
plot_edgeR(~ smokingstatus + RACE + GENDER + AGEGRP4C + SR_ACTIVE + EDU3CAT + DBTS_NEW , coef = 2, pseq = NYC_HANES, alph = 0.05, color = "Phylum", sortby = "Phylum") -> edger.multiv
```
...
```{r edgeR_univ_vs_multiv, echo=FALSE, message=FALSE, warning=FALSE,  fig.width=6}
...
```{r edger_cotinine_univ, echo=FALSE,  fig.width=6, message=FALSE, warning=FALSE}
...
```{r edgeR_alternative, echo=FALSE, cache=TRUE,  fig.width=6}
sample_data(NYC_HANES)$smokingstatus <- relevel(sample_data(NYC_HANES)$smokingstatus,"Never smoker")
...
```{r edgeR_ecigs, echo=FALSE, cache=TRUE,  fig.width=6}
...
```{r edgeR_hookah, echo=FALSE, cache=TRUE,  fig.width=6}
...
```{r edgeR_cigars, echo=FALSE, cache=TRUE,  fig.width=6}
